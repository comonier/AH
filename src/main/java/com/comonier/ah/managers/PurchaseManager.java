...
public class PurchaseManager {
    ...
    /**
     * Registra um item comprado no histórico do comprador
     */
    public void recordPurchase(UUID buyer, AuctionItem item) {
        ...
        try {
            ...
            plugin.getLogger().severe("Erro ao salvar purchases.yml!");
        }
    }

    /**
     * Retorna a lista de itens comprados por um jogador
     */
