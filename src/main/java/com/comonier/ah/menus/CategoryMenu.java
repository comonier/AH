...
public class CategoryMenu {
    ...
    /**
     * Abre o menu principal de categorias para o jogador
     */
    public void open(Player player) {
        ...
        gui.setItem(13, new ItemBuilder(Material.BOOK)
                .setName(mm.getMessage("button-all")).build());

        // Fileira 1 de Categorias (Slots 19-25)
        ...
        // Fileira 2 de Categorias (Slots 28-34)
